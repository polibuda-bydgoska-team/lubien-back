...
.mj-column-per-50 { width:50% !important; max-width: 50%; }
  ...
  @media only screen and (max-width:480px) {
    ...
    <img height="auto" src="https://s3-eu-west-1.amazonaws.com/topolio/uploads/60a2803c92fff/1621262688.jpg" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="420">
          ...
          <tr>
            <td align="left" style="font-size:0px;padding:20px 15px 0px 15px;word-break:break-word;">
              
    <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1.5;text-align:left;color:#000000;"><p><span style="font-size: 14px; font-family: Cabin, sans-serif;"><strong>YOU'RE ONE STEP AWAY</strong></span></p></div>
    ...
    <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1.5;text-align:left;color:#000000;"><h1 style="font-family: 'Cabin', sans-serif; text-align: left;"><span style="font-size: 36px;">Verify your email address</span></h1></div>
    ...
    <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1.5;text-align:left;color:#000000;"><p style="text-align: justify;"><span style="font-size: 17px;">To complete your profile and be able to start shopping at Lubien, you'll need to verify your email address.</span></p></div>
    ...
    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;width:auto;line-height:100%;">
      <tr>
        <td align="center" bgcolor="#007EFF" role="presentation" style="border:0px solid #000;border-radius:25px;cursor:auto;mso-padding-alt:9px 26px 9px 26px;background:#007EFF;" valign="middle">
          <a href="${clientURI}/user/confirmation/${userEmail}/${token}" style="display: inline-block; background: #007EFF; color: #ffffff; font-family: Ubuntu, Helvetica, Arial, sans-serif, Helvetica, Arial, sans-serif; font-size: 22px; font-weight: normal; line-height: 27.5px; margin: 0; text-decoration: none; text-transform: none; padding: 9px 26px 9px 26px; mso-padding-alt: 0px; border-radius: 25px;" target="_blank">
            <span style="font-size: 22px; font-family: Cabin, sans-serif;">VERIFY</span>
          </a>
        </td>
      </tr>
    </table>
